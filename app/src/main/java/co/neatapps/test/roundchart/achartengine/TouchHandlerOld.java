...
import co.neatapps.test.roundchart.achartengine.*;
import co.neatapps.test.roundchart.achartengine.GraphicalView;
import co.neatapps.test.roundchart.achartengine.chart.AbstractChart;
import co.neatapps.test.roundchart.achartengine.chart.RoundChart;
...
import co.neatapps.test.roundchart.achartengine.tools.Pan;
import co.neatapps.test.roundchart.achartengine.tools.PanListener;
import co.neatapps.test.roundchart.achartengine.tools.ZoomListener;
 ...
 */
public class TouchHandlerOld implements co.neatapps.test.roundchart.achartengine.ITouchHandler {
    /** The chart renderer. */
    ...
    private Pan mPan;
    /** The graphical view. */
    private co.neatapps.test.roundchart.achartengine.GraphicalView graphicalView;
