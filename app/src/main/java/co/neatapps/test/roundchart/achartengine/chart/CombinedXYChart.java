...
import co.neatapps.test.roundchart.achartengine.model.XYMultipleSeriesDataset;
import co.neatapps.test.roundchart.achartengine.model.XYSeries;
...
import co.neatapps.test.roundchart.achartengine.renderer.XYSeriesRenderer;

import android.graphics.Canvas;
import android.graphics.Paint;

import co.neatapps.test.roundchart.achartengine.chart.*;
...
import co.neatapps.test.roundchart.achartengine.chart.ClickableArea;
import co.neatapps.test.roundchart.achartengine.chart.CubicLineChart;
...
import co.neatapps.test.roundchart.achartengine.chart.XYChart;

/**
 * The combined XY chart rendering class.
 */
public class CombinedXYChart extends co.neatapps.test.roundchart.achartengine.chart.XYChart {

    private XYCombinedChartDef[] chartDefinitions;

    /** The embedded XY charts. */
    private co.neatapps.test.roundchart.achartengine.chart.XYChart[] mCharts;

    /** The supported charts for being combined. */
    private Class<?>[] xyChartTypes = new Class<?>[]{co.neatapps.test.roundchart.achartengine.chart.TimeChart.class, LineChart.class,
    ...
    public CombinedXYChart(XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer,
        ...
        mCharts = new co.neatapps.test.roundchart.achartengine.chart.XYChart[length];
     ...
     */
    public CombinedXYChart(XYMultipleSeriesDataset dataset, XYMultipleSeriesRenderer renderer,
                           XYCombinedChartDef[] chartDefinitions, co.neatapps.test.roundchart.achartengine.chart.XYChart[] charts) {
        super(dataset, renderer);
        this.chartDefinitions = chartDefinitions;
        this.mCharts = charts;
    }
     ...
     */
    private co.neatapps.test.roundchart.achartengine.chart.XYChart getXYChart(String type) throws IllegalAccessException, InstantiationException {
        co.neatapps.test.roundchart.achartengine.chart.XYChart chart = null;
        int length = xyChartTypes.length;
        for (int i = 0; i < length && chart == null; i++) {
            co.neatapps.test.roundchart.achartengine.chart.XYChart newChart = (co.neatapps.test.roundchart.achartengine.chart.XYChart) xyChartTypes[i].newInstance();
    ...
    public void drawSeries(Canvas canvas, Paint paint, List<Float> points,
        ...
        co.neatapps.test.roundchart.achartengine.chart.XYChart chart = getXYChart(seriesIndex);
