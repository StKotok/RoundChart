 ...
 */
package co.neatapps.test.roundchart.achartengine.renderer;
...
import co.neatapps.test.roundchart.achartengine.renderer.*;

import co.neatapps.test.roundchart.achartengine.renderer.XYSeriesRenderer.FillOutsideLine.Type;
...
public class XYSeriesRenderer extends SimpleSeriesRenderer {
    ...
    private int mAnnotationsColor = co.neatapps.test.roundchart.achartengine.renderer.DefaultRenderer.TEXT_COLOR;
