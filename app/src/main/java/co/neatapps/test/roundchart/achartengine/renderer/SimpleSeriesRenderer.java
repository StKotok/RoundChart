...
public class SimpleSeriesRenderer implements Serializable {
    ...
    /** The stroke style. */
    private co.neatapps.test.roundchart.achartengine.renderer.BasicStroke mStroke;
     ...
     */
    public co.neatapps.test.roundchart.achartengine.renderer.BasicStroke getStroke() {
        return mStroke;
    }
     ...
     */
    public void setStroke(co.neatapps.test.roundchart.achartengine.renderer.BasicStroke stroke) {
        mStroke = stroke;
    }
