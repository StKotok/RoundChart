 ...
 */
public class RangeCategorySeries extends co.neatapps.test.roundchart.achartengine.model.CategorySeries {
    /** The series values. */
    ...
    public co.neatapps.test.roundchart.achartengine.model.XYSeries toXYSeries() {
        co.neatapps.test.roundchart.achartengine.model.XYSeries xySeries = new XYSeries(getTitle());
