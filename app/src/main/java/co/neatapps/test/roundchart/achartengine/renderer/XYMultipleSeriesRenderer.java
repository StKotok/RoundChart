 ...
 */
public class XYMultipleSeriesRenderer extends co.neatapps.test.roundchart.achartengine.renderer.DefaultRenderer {
    /** The X axis title. */
    ...
    /**
     * Override {@link co.neatapps.test.roundchart.achartengine.renderer.DefaultRenderer#setPanEnabled(boolean)} so it can be
