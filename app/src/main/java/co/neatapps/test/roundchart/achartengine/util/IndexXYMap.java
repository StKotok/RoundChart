 ...
 */
package co.neatapps.test.roundchart.achartengine.util;
...
import co.neatapps.test.roundchart.achartengine.util.*;
...
public class IndexXYMap<K, V> extends TreeMap<K, V> {
     ...
     */
    public co.neatapps.test.roundchart.achartengine.util.XYEntry<K, V> getByIndex(int index) {
        K key = indexList.get(index);
        return new co.neatapps.test.roundchart.achartengine.util.XYEntry<K, V>(key, this.get(key));
    }
     ...
     * @param index
     */
    public co.neatapps.test.roundchart.achartengine.util.XYEntry<K, V> removeByIndex(int index) {
        K key = indexList.remove(index);
        return new co.neatapps.test.roundchart.achartengine.util.XYEntry<K, V>(key, this.remove(key));
    }
