...
import co.neatapps.test.roundchart.achartengine.chart.PointStyle;

import static co.neatapps.test.roundchart.achartengine.chart.PointStyle.*;

/**
 * The scatter chart rendering class.
 */
public class ScatterChart extends co.neatapps.test.roundchart.achartengine.chart.XYChart {
